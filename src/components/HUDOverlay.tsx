  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="fixed top-0 left-0 md:left-20 right-0 h-10 z-40 flex items-center justify-between px-3 sm:px-4 md:px-6 bg-[#0d0d12]/50 border-b border-[#ff2d55]/10"
      >
        {/* Left: System status */}
        <div className="flex items-center gap-3 sm:gap-6">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-[#00ff88] rounded-full pulse-glow" />
            <span className="text-[10px] tracking-[0.2em] text-[#00ff88] font-['Share_Tech_Mono',monospace]">
              ONLINE
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] tracking-widest text-gray-500 font-['Share_Tech_Mono',monospace]">
              SS v2.047
            </span>
          </div>
        </div>

        {/* Center: Current section (hidden on small screens) */}
        ...
        <div className="hidden sm:flex items-center gap-4 text-[10px] font-['Share_Tech_Mono',monospace]">
      ...
      <motion.div 
        ...
        className="fixed bottom-0 left-0 md:left-20 right-0 h-8 z-40 flex items-center justify-between px-3 sm:px-4 md:px-6 bg-[#0d0d12]/50 border-t border-[#ff2d55]/10"
      >
        {/* Left: Time */}
        ...
        {/* Center decoration (hidden on mobile) */}
        ...
        <div className="flex items-center gap-2 text-right">
          ...
          <span className="text-[10px] tracking-widest text-gray-600 font-['Share_Tech_Mono',monospace] break-all">
            DOMAIN: <span className="text-[#ff00ff]">Software Development</span>
          </span>
        </div>
      </motion.div>

      {/* Corner decorations (hidden on mobile) */}
      <div className="hidden md:block fixed top-10 left-20 w-24 h-24 pointer-events-none z-30">
      ...
      <div className="hidden md:block fixed top-10 right-0 w-24 h-24 pointer-events-none z-30">
