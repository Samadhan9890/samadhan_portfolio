...
export default function HeroSection() {
  return (
    <motion.div
      ...
      className="min-h-screen flex items-center justify-center px-4 sm:px-6 md:pl-20 md:pr-8 pt-10"
    >
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div>
            ...
            {/* NAME FIX */}
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-['Orbitron'] font-bold leading-tight mb-6">
              <span className="text-white">SAMADHAN</span>
              <br />
              <span className="text-[#ff2d55]">SHEGDE</span>
            </h1>

            <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-md mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="/SamadhanShegde_Java_developer.pdf" download>
                <button className="w-full sm:w-auto px-6 py-3 border border-[#ff2d55] text-[#ff2d55] hover:bg-[#ff2d55] hover:text-black flex items-center justify-center gap-2">
              ...
              <button 
                ...
                className="w-full sm:w-auto px-6 py-3 border border-[#ff2d55]/30 text-gray-400 hover:border-[#ff2d55] hover:text-[#ff2d55]"
              >
                VIEW PROJECTS
              </button>
          ...
          <div className="relative mt-8 md:mt-0">
            <div className="border border-[#ff2d55]/30 p-4 sm:p-6 bg-[#0d0d12]/50">
            ...
            {/* Decorative */}
            <Zap className="absolute -top-4 -right-4 text-[#ff00ff]" size={24} />
            <Shield className="absolute -bottom-4 -right-4 text-[#ff2d55]/30" size={26} />
          </div>
